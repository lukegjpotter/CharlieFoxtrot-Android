...
public class DisplayActivity extends Activity {
    ...
    public OnClickListener saveQueryButtonListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            // Hide the input keyboard when the button is clicked.
            ...
            if (queryEditText.getText().length() > 0) {
                ...
                builder.setMessage(formatMissingMessage());
    ...
    private Button queryButton;             // Button that triggers the querying process.
    ...
    private void makeTag(String query, String tag) {
        ...
        if (!queryHistory.contains(originalQuery)) {
    ...
    private void displayPhonetics(String query) {
        ...
        int maxQueryLength = getResources().getInteger(R.integer.maxQueryLength);
        if (query.length() >= maxQueryLength) {

            makeTag(query, query.substring(0, maxQueryLength));
        } else {
    ...
    private String formatMissingMessage() {

        String queryPrompt = getResources().getString(R.string.queryPrompt);
        String missingMessage = getResources().getString(R.string.missingMessage);

        return String.format(missingMessage, queryPrompt);
    }
}
